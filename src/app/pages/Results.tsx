...
import { applyRemoteSearchRanking, buildSearchSuggestions, getAISearchStatus, getRemoteMatchReasons, normalizeText, parseNaturalSearch, rankPropertiesBySearch, searchPropertiesWithAI, type AIStatus, type RemoteAISearchResult } from "../lib/aiSearch";
...
export default function Results() {
  ...
  const suggestions = useMemo(() => {
    return buildSearchSuggestions(properties, searchQuery);
  ...
  }, [amenities, normalizedQuery, properties, remoteResult, searchQuery, selectedAmenities, selectedTypes]);
